...
const mockUploadCoverageFiles = uploadCoverageFiles as jest.MockedFunction<
  typeof uploadCoverageFiles
>;
const mockFindCoverageFiles = findCoverageFiles as jest.MockedFunction<
  typeof findCoverageFiles
>;
const mockGetGitHubContext = getGitHubContext as jest.MockedFunction<
  typeof getGitHubContext
>;
...
describe("index (run)", () => {
  ...
  async function runAction() {
    ...
    jest.doMock("../uploader", () => ({
      uploadCoverageFiles: mockUploadCoverageFiles,
    }));
    jest.doMock("../file-finder", () => ({
      findCoverageFiles: mockFindCoverageFiles,
    }));
    jest.doMock("../github-context", () => ({
      getGitHubContext: mockGetGitHubContext,
    }));
